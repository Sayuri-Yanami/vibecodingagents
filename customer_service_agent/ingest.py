...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="构建 AI 客服本地知识库索引")
    parser.add_argument("--chunk-size", type=int, default=650, help="每个文档块的最大字符数")
    parser.add_argument("--chunk-overlap", type=int, default=80, help="相邻文档块重叠字符数")
